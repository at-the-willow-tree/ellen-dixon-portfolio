...
function updatePictures() {
  picture.src = imageRoot + currentSection + "/" + currentIndex + ".jpg";
  hiddenPictures[0].src = imageRoot + currentSection + "/" + prevIndex + ".jpg";
  hiddenPictures[1].src = imageRoot + currentSection + "/" + nextIndex + ".jpg";
